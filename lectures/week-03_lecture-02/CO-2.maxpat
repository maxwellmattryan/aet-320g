...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 356.0, 764.705914258956909, 69.0, 22.0 ],
									"text" : "noteout a 1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 356.0, 720.588265359401703, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 286.235265672206879, 720.588265359401703, 50.0, 22.0 ],
									"text" : "62"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 356.0, 682.470588088035583, 32.0, 22.0 ],
									"text" : "ftom"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 228.794099926948547, 425.000001668930054, 29.5, 22.0 ],
									"text" : "2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 315.544099926948547, 425.000001668930054, 29.5, 22.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 269.544099926948547, 425.000001668930054, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 228.794099926948547, 385.000001668930054, 90.0, 22.0 ],
									"text" : "select 29 30 31"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 182.294099926948547, 385.000001668930054, 32.0, 22.0 ],
									"text" : "127"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 228.794099926948547, 341.000001668930054, 50.5, 22.0 ],
									"text" : "key"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 286.235265672206879, 682.470588088035583, 50.0, 22.0 ],
									"text" : "300."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 803.0, 584.0, 29.5, 22.0 ],
									"text" : "3."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 760.0, 584.0, 29.5, 22.0 ],
									"text" : "2."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 720.0, 584.0, 29.5, 22.0 ],
									"text" : "1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 678.5, 584.0, 29.5, 22.0 ],
									"text" : "0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 707.0, 502.0, 50.0, 22.0 ],
									"text" : "127"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 678.5, 536.0, 107.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "int", "int", "int" ],
									"patching_rect" : [ 678.5, 461.0, 50.5, 22.0 ],
									"text" : "key"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1112.0, 711.0, 242.0, 365.0 ],
									"text" : "***(5) ADD TWO other interactvity features to shape the outgoing note velocities and durations for the \"makenote\" object. Thoroughly comment each of your features and how they (should) work.\n\n***Hints: \n\nFor velocity (makenote 2nd inlet), try using a system to choose between two (or more) velocities. (This can be accomplished with the \"random\" or \"decide\" objects.) \n\nFor duration you might want to use the horizontal position of the mouse and/or a slider into the scale object to map usable durations.\n\nLASTLY, I recommend adding more chord possibilities using the key triggering system in Step (4). This will add much more ability to use this system in live performance situations.\n\nOFFICE HOUR: Wednesdays, 4:45 to 5:30pm in DFA AV Studio (4th floor)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 537.0, 584.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 469.0, 584.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 394.0, 585.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 319.0, 585.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 460.0, 385.0, 70.0, 22.0 ],
									"text" : "loadmess 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 842.0, 472.5, 268.0, 245.0 ],
									"text" : "***(4) ADD the following:\n\n1 key   triggers 0.5, changes multiplier to 0.5; number received from message is multiplied by 0.5 (50, 100, 150, 200)\n\n2 key   triggers 1, changes multiplier to 1; number received from message is multiplied by 1 (100, 200, 300, 500)\n\n3 key   triggers 2, changes multiplier to 2; number received from message is multiplied by 2 (200, 400, 600, 800)\n\n4 key   triggers 3, changes multiplier to 3; number received from message is multiplied by 3 (300, 600, 900, 1200)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 193.0, 188.5, 150.0, 66.0 ],
									"text" : "***(1) ADD feature where space bar activates the toggle and starts the metro"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 579.5, 119.0, 153.0, 79.0 ],
									"text" : "***(2) INTEGRATE mousestate into this patch to control the metro speed interactively."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 543.25, 345.0, 50.0, 22.0 ],
									"text" : "select 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.25, 385.0, 29.5, 22.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 749.0, 23.0, 457.0, 41.0 ],
									"text" : "Interactive Sawtooth Arpeggiator"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 66.0, 478.0, 150.0, 89.0 ],
									"text" : "When toggle is off gain slider is at 0\n\nWhen toggle is on, gain slider gets value of 127 (unity gain level)"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 847.0, 67.0, 358.0, 200.0 ],
									"text" : "How to Use the Arpeggiator:\n\n1. Turn on the ezdac~\n\n2. Press the space bar to start the metro and activate the counter\n\n3. Use the up arrow key, down arrow key, and right arrow key to change the counter direction\n\n4. Use the 1, 2, 3 and 4 keys to change the multiplier of the frequency value sent to the sawtooth wave generator\n\n5. Use the vertical position of the mouse to control the rate of the metro"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 356.0, 637.0, 341.5, 22.0 ],
									"text" : "* 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 571.25, 584.0, 31.0, 22.0 ],
									"text" : "400"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 499.5, 584.0, 31.0, 22.0 ],
									"text" : "300"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 427.75, 585.0, 31.0, 22.0 ],
									"text" : "200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 356.0, 585.0, 31.0, 22.0 ],
									"text" : "100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "bang", "bang", "bang", "bang", "" ],
									"patching_rect" : [ 356.0, 536.0, 306.0, 22.0 ],
									"text" : "select 0 1 2 3"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 469.0, 269.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 356.0, 478.0, 79.0, 22.0 ],
									"text" : "counter 0 0 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 356.0, 345.0, 132.0, 22.0 ],
									"text" : "metro 500"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 356.0, 277.0, 24.0, 24.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 552.75, 465.0, 395.5, 465.0 ],
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 365.5, 326.5, 552.75, 326.5 ],
									"order" : 0,
									"source" : [ "obj-8", 0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 189.0, 266.0, 139.0, 22.0 ],
									"text" : "scale 0 1154 31.25 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 341.0, 237.5, 171.0, 79.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 189.0, 354.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 233.5, 188.0, 50.0, 22.0 ]
								}
